/**
 * footer.test.js — Tests Unitarios del Bloque Footer
 * Framework: vitest
 *
 * Generado por SA-D03 del Sprint 2 — Red Agéntica AEM
 * Ejecutar: npx vitest run blocks/footer/footer.test.js
 */
...
/**
 * Crea un bloque footer mínimo para tests.
...
describe('Footer Block', () => {
  ...
  it('añade la clase de inicialización al bloque', async () => {
    ...
    decorate(block);
    expect(block.classList.contains('footer--initialized')).toBe(true);
  });
  ...
  it('no lanza errores con un bloque vacío', async () => {
    ...
    emptyBlock.classList.add('footer');
