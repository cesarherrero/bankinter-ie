/**
 * institutions.js — Bloque AEM EDS: Institutions
...
/**
 * Decora el bloque institutions añadiendo comportamiento interactivo y accesibilidad.
...
export default function decorate(block) {
  ...
  block.classList.add('institutions--initialized');

  // Implementación genérica — añadir lógica específica del componente
  const items = block.querySelectorAll(':scope > div');
  items.forEach((item, index) => {
    item.classList.add('institutions__item');
